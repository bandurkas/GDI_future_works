        ...
        <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
            <div className={styles.container}>
                <Link href="/" className={styles.logo}>
                    <span className={styles.logoText}>GDI <span>FutureWorks</span></span>
                </Link>

                <nav className={styles.nav} aria-label="Main navigation">
                    <Link href="/" className={styles.navLink}><Translate tKey="nav.courses" defaultText="Courses" /></Link>
                ...
                <div className={styles.actions}>
                    <a href="https://wa.me/6282258720974" target="_blank" rel="noopener noreferrer" className={styles.navChatBtn} aria-label="Chat with us on WhatsApp">
                    ...
                    <Link href="/cart" className={styles.cartBtn} aria-label="View shopping cart">
                    ...
                    <button className={styles.themeToggle} onClick={toggleLanguage} aria-label="Toggle language" style={{ fontWeight: 700, fontSize: '0.85rem' }}>
                        {language === 'en' ? 'EN' : 'ID'}
                    </button>
                </div>
            </div>
