        ...
        <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
            <div className={styles.container}>
                <Link href="/" className={styles.logo}>
                    <div className={styles.logoMark}><span>GDI</span></div>
                ...
                <div className={styles.actions}>
                    <a href="https://wa.me/62000000000" target="_blank" rel="noopener noreferrer" className={styles.navChatBtn} aria-label="Chat with us on WhatsApp">
