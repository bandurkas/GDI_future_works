            ...
            <div className={styles.container}>
                ...
                <div className={styles.rightSection}>
                    <div className={styles.actions}>
                        ...
                        <a href="https://wa.me/628211704707" target="_blank" rel="noopener noreferrer" className={styles.navChatBtn} aria-label="Chat with us on WhatsApp" onClick={() => trackConversion('whatsapp_click', 'whatsapp_header')}>
