...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'apply.f.video.hint': 'Record yourself teaching a short concept. Host it on Loom, YouTube, or Vimeo and paste the link below.',
    ...
    id: {
        ...
        'apply.f.video.hint': 'Rekam dirimu mengajar konsep singkat. Upload ke Loom, YouTube, atau Vimeo lalu tempel tautannya.',
