                ...
                <div className={styles.top}>
                    <div className={styles.brand}>
                        <Link href="/" className={styles.logo}>
                            <div className={styles.logoMark}>GDI</div>
                    ...
                    <div className={styles.links}>
                        {[
                            ...
                            {
                                title: 'Support', items: [
                                    { label: 'Chat on WhatsApp', href: 'https://wa.me/62000000000' },
                                    { label: 'hello@gdieduhub.com', href: 'mailto:hello@gdieduhub.com' },
