                ...
                <div className={styles.top}>
                    ...
                    <div className={styles.links}>
                        {[
                            ...
                            {
                                title: 'Support', items: [
                                    { label: 'Chat on WhatsApp', href: 'https://wa.me/6282258720974' },
