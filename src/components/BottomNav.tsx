...
export default function BottomNav() {
    ...
    // Hide on all course sub-pages (where StickyBookingBar appears)
    ...
    return (
        <nav className={styles.bottomNav} aria-label="Mobile navigation">
            {tabs.map((tab) => {
                const isActive =
                    pathname === tab.href ||
                    (tab.href !== '/' && tab.href !== '/#cohort' && pathname.startsWith(tab.href));
                return (
                    <Link
                        key={tab.name}
                        href={tab.href}
                    ...
                    >
                        ...
                        <span className={styles.label} aria-hidden="true">{tab.name}</span>
                    </Link>
                );
            })}
        </nav>
