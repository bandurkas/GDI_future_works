...
export default function LearningHubOnboarding({ firstName, isAdmin }: Props) {
  ...
  const CATEGORIES = [
    {
      id: 'data-analytics',
      title: t('onboard.cat.data.title'),
      description: t('onboard.cat.data.desc'),
      iconBg: '#E8F0FE',
      iconColor: '#1A56C4',
      icon: (
    ...
    {
      id: 'programming',
      title: t('onboard.cat.programming.title'),
      description: t('onboard.cat.programming.desc'),
      iconBg: '#E8F5E9',
      iconColor: '#2E7D32',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    {
      id: 'ai-ml',
      title: t('onboard.cat.ai.title'),
      description: t('onboard.cat.ai.desc'),
      iconBg: '#FFF3E0',
      iconColor: '#E65100',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    {
      id: 'digital-skills',
      title: t('onboard.cat.digital.title'),
      description: t('onboard.cat.digital.desc'),
      iconBg: '#F3E5F5',
      iconColor: '#6A1B9A',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.progressContainer} role="progressbar" aria-valuenow={33} aria-valuemin={0} aria-valuemax={100} aria-valuetext={`${t('onboard.step')} 1 ${t('onboard.of')} 3`}>
        <div className={styles.progressLabel}>
          <span className={styles.progressStep}>{t('onboard.step')} 1 {t('onboard.of')} 3</span>
          <span className={styles.progressDesc}>— {t('onboard.stepDesc')}</span>
        </div>
      ...
      <div className={styles.header}>
        <h1 className={styles.headerTitle}>
          {t('onboard.welcome')} {firstName} <span className={styles.wave}>👋</span>
        </h1>
      ...
      <div className={styles.actionBar}>
        <div className={styles.actionContainer}>
            <div className={styles.ctaWrapper}>
                ...
                >
                {hasSelection ? t('onboard.seeMyCourses') : t('onboard.continue')}
      ...
      >
        ...
        <span className={styles.fabTooltip}>
          {t('onboard.advisor')}
          <span className={styles.fabTooltipSub}>{t('onboard.advisorHours')}</span>
        </span>
      </a>
