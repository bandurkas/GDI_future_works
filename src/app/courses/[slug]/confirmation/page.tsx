                    ...
                    {isQris ? (
                        ...
                        <>
                            ...
                            <div className={styles.text}>
                                <h1 className={styles.title}>Payment Under Review</h1>
                                <p className={styles.subtitle}>
                                    Your receipt has been submitted. Our team will verify your payment within{' '}
                                    <strong>5–30 minutes</strong> and send a WhatsApp confirmation.
                                </p>
                            </div>
                            ...
                            <div className={styles.nextSteps}>
                                ...
                                {[
                                    { icon: '🔍', step: 'Our admin reviews your receipt (5–30 min).' },
                                    { icon: '📱', step: 'WhatsApp confirmation sent once verified.' },
                                    { icon: '🔗', step: 'Click your session link at class start time.' },
                                    { icon: '🎓', step: 'Certificate issued after course completion.' },
                                ].map((item, i) => (
                        ...
                        <>
                            ...
                            <div className={styles.text}>
                                ...
                                <p className={styles.subtitle}>
                                    Your session is confirmed. You&apos;ll receive your access link on WhatsApp in the next{' '}
