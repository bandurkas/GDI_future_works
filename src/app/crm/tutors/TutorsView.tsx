...
type Application = {
  ...
  whatsapp: string | null; linkedin: string | null; videoLink: string | null; portfolioLink: string | null;
    ...
    <div className={s.card} style={{ borderLeft: `3px solid ${sc.border}` }}>
      ...
      {expanded && (
        <div className={s.expandBody}>
          ...
          {(a.whatsapp || a.linkedin || a.videoLink || a.portfolioLink) && (
              ...
              {a.whatsapp && (
                ...
                >
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.554 4.122 1.523 5.855L0 24l6.335-1.502A11.956 11.956 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 0 1-5.006-1.369l-.36-.214-3.732.884.937-3.63-.235-.374A9.818 9.818 0 1 1 12 21.818z"/>
                  </svg>
                  {a.whatsapp}
                </a>
              )}
